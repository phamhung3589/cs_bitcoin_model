...
class SqlTwitterSearchWeekConnection:
    """
    ...
    def create_table(self):
        ...
        """
        tables = {'twitter_search_trending':
                      "CREATE TABLE IF NOT EXISTS `twitter_search_week_trending` ("
        ...
        self.cursor.execute(tables['twitter_search_trending'])
    ...
    def insert_data(self, data: dict):
        ...
        add_data = ("REPLACE INTO twitter_search_week_trending "
    ...
    def delete_data(self, key: datetime):
        sql_query = f"DELETE FROM twitter_search_week_trending where datetime = '%s'"
    ...
    def get_data_from_db(self, filter_date):
        ...
        """
        sql_query = f"SELECT * FROM twitter_search_week_trending where datetime = '%s'"
...
if __name__ == "__main__":
    date = datetime.fromtimestamp(datetime.utcnow().timestamp() - 360 * 60).replace(minute=0, second=0)
