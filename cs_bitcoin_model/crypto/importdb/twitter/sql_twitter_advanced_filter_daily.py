...
class SqlTwitterAdvanceFilterDailyConnection:
    """
    ...
    def create_table(self):
        ...
        """
        tables = {'twitter_advanced_filter_daily':
                      "CREATE TABLE IF NOT EXISTS `twitter_advanced_filter_daily` ("
        ...
        self.cursor.execute(tables['twitter_advanced_filter_daily'])
    ...
    def insert_data(self, data: dict):
        ...
        add_data = ("REPLACE INTO twitter_advanced_filter_daily "
    ...
    def delete_data(self, key: datetime):
        sql_query = f"DELETE FROM twitter_advanced_filter_daily where datetime = '%s'"
    ...
    def get_data_from_db(self, filter_date):
        ...
        """
        sql_query = f"SELECT * FROM twitter_advanced_filter_daily where datetime = '%s'"
