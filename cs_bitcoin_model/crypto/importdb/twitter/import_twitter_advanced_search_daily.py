...
from cs_bitcoin_model.crypto.aggregate.social.twitter_recent_search import get_advanced_filter_tweets_daily
...
def run(date):
    ...
    data_nft, data_defi, data_web3, data_ico = get_advanced_filter_tweets_daily(date)
